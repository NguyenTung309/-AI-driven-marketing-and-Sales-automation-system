...
public readonly record struct LlmCallContext(Guid TenantId, string AgentCode, DateTimeOffset? CostAt = null, Guid? ReservationId = null);
...
public interface ILlmCallScope
{
    ...
    IDisposable Begin(Guid tenantId, string agentCode, DateTimeOffset? costAt = null, Guid? reservationId = null);
}
...
public sealed class LlmCallScope : ILlmCallScope
{
    ...
    public IDisposable Begin(Guid tenantId, string agentCode, DateTimeOffset? costAt = null, Guid? reservationId = null)
    {
        ...
        Ambient.Value = new LlmCallContext(tenantId, agentCode, costAt ?? previous?.CostAt, reservationId ?? previous?.ReservationId);
