...
USING (VALUES
    ...
    (N'KB-003', N'First', N'(?i)(trung tâm.*(ở đâu|địa chỉ)|học online|học offline)', N'Trung tâm dạy 100% online lớp trực tiếp với giáo viên qua Zoom, không có lớp offline ạ. Bạn ở tỉnh thành nào, kể cả nước ngoài, đều học được; mỗi buổi có video ghi lại để xem lại. Bạn muốn học giao tiếp hay luyện thi HSK để mình tư vấn lớp phù hợp ạ?', N'consultative', N'all'),
    ...
    (N'KB-005', N'First', N'(?i)(học.*(bao lâu|mất bao lâu)|nhanh không)', N'Tuỳ mục tiêu bạn nhé: từ số 0 lên HSK3 khoảng 5-6 tháng (61 buổi), lên HSK4 khoảng 9 tháng (106 buổi), học theo nhóm ngày 2-4-6 hoặc 3-5-7. Bạn muốn đạt mục tiêu trong khoảng thời gian nào ạ?', N'consultative', N'all'),
    (N'KB-006', N'First', N'(?i)(con mình|cho bé|trẻ em|học sinh cấp)', N'Dạ bé nhà mình bao nhiêu tuổi và đang muốn học theo hướng nào ạ? Mình xin thông tin để tư vấn viên kiểm tra lớp phù hợp rồi báo lại chi tiết cho mình nhé.', N'warm', N'all'),
    ...
    (N'KB-008', N'First', N'(?i)(học thử|trải nghiệm|buổi demo|test trình)', N'Trung tâm có buổi học thử miễn phí + bài test xếp lớp đầu vào, tất cả đều online ạ. Bạn muốn học thử khung sáng 8h30-10h hay tối 18h30-20h / 20h-21h30 ạ?', N'inviting', N'all'),
    ...
    (N'KB-010', N'Lộ trình', N'(?i)(hsk\s*1|sơ cấp|cơ bản nhất)', N'Khoá HSK2 từ số 0 phù hợp người mới: 34 buổi, khoảng 2,8 tháng, khoảng 300 từ vựng, giao tiếp tình huống cơ bản. Học xong bạn tự giới thiệu, mua sắm, hỏi đường tốt. Bạn muốn xem lộ trình chi tiết không ạ?', N'structured', N'all'),
    (N'KB-011', N'Lộ trình', N'(?i)(hsk\s*3|trung cấp)', N'HSK3 là mốc nhiều bạn cần cho công việc/du học: khoảng 600 từ, đọc hiểu đoạn văn. Từ HSK2 lên HSK3 học 27 buổi khoảng 2,3 tháng; từ số 0 có combo lên HSK3 61 buổi khoảng 5-6 tháng. Mình gửi bạn lộ trình chi tiết nhé?', N'structured', N'all'),
    ...
    (N'KB-013', N'Lộ trình', N'(?i)(giao tiếp|nói chuyện|khẩu ngữ|nghe nói)', N'Dòng HỌC BÁ CHINESE chuyên giao tiếp và tiếng Trung thương mại: lớp online trực tiếp, luyện nói theo chủ đề thực tế, sĩ số nhỏ để bạn được nói nhiều. Bạn muốn giao tiếp cho du lịch, công việc hay đời sống ạ?', N'energetic', N'all'),
    ...
    (N'KB-015', N'Lộ trình', N'(?i)(giáo trình|tài liệu|sách học|học bằng gì)', N'Dòng luyện thi dùng Giáo trình chuẩn HSK 标准教程, dòng giao tiếp dùng New Target Chinese Spoken Language, kèm hệ thống LMS có flashcard, bài tập và tài liệu ôn tập. Bạn học theo hướng thi HSK hay giao tiếp để mình tư vấn bộ giáo trình đúng ạ?', N'informative', N'all'),
    (N'KB-016', N'Lộ trình', N'(?i)(lớp.*(mấy người|sĩ số|bao nhiêu học viên)|lớp nhỏ)', N'Lớp nhóm 8-10 học viên, riêng HSK6 chỉ 6-8 bạn; mỗi học viên còn có 1 mentor riêng theo sát ngoài giáo viên đứng lớp ạ. Bạn thích lớp nhóm hay học 1 kèm 1 ạ?', N'reassuring', N'all'),
    (N'KB-017', N'Lộ trình', N'(?i)(1 kèm 1|gia sư|học riêng|cá nhân)', N'Lớp 1 kèm 1 học riêng một thầy một trò, lịch linh hoạt theo thoả thuận với giáo viên, học phí thu theo từng gói 10 buổi thay vì đóng trọn khoá. Bạn muốn mình tư vấn lộ trình 1 kèm 1 theo mục tiêu của bạn không ạ?', N'consultative', N'all'),
    ...
    (N'KB-019', N'Objection', N'(?i)(giá|học phí|bao nhiêu tiền|chi phí|phí.*khoá)', N'Học phí sau ưu đãi 20%: khoá HSK2 từ số 0 còn 3.280.000đ cho 34 buổi, khoá HSK3 còn 3.280.000đ cho 27 buổi, khoá HSK4 còn 5.840.000đ cho 45 buổi; combo từ số 0 được ưu đãi 30%. Tiền sách thu riêng một lần khi nhập học. Bạn muốn mình gửi bảng giá chi tiết theo mục tiêu của bạn không ạ?', N'transparent', N'all'),
    (N'KB-020', N'Objection', N'(?i)(đắt|mắc quá|hơi cao|cao quá|không có tiền)', N'Mình hiểu ạ. Học phí chia được nhiều đợt mà vẫn giữ nguyên mức ưu đãi, tính ra chỉ khoảng 94.000-173.000đ một buổi tuỳ khoá, lớp sĩ số nhỏ lại có mentor kèm riêng. Combo nhiều cấp giảm 30%, càng dài càng rẻ theo buổi. Bạn muốn mình tư vấn gói tiết kiệm nhất theo mục tiêu của bạn không ạ?', N'empathetic', N'all'),
    ...
    (N'KB-022', N'Objection', N'(?i)(sợ.*(khó|không theo được)|học không vào|tiếng trung khó)', N'Rất nhiều bạn mất gốc đã học tốt nhờ phương pháp chia nhỏ + luyện lặp lại của trung tâm ạ. Mỗi học viên có 1 giáo viên và 1 mentor riêng theo sát, cứ 5 buổi có 1 buổi ôn tập nên bạn không lo bị bỏ lại. Bạn muốn thử 1 buổi xem có hợp không nhé?', N'encouraging', N'all'),
    (N'KB-023', N'Objection', N'(?i)(bận|không có thời gian|sợ.*không sắp xếp)', N'Trung tâm có lớp tối 18h30-20h và 20h-21h30 theo nhóm ngày 2-4-6 hoặc 3-5-7, học online nên không mất thời gian di chuyển, mỗi buổi đều có video ghi lại để bạn xem bù nếu bận. Bạn thường rảnh khung giờ nào ạ?', N'flexible', N'all'),
    ...
    (N'KB-025', N'Objection', N'(?i)(trung tâm khác|chỗ khác rẻ hơn|so sánh)', N'Mỗi nơi một thế mạnh ạ. Điểm khác biệt của trung tâm là sĩ số nhỏ 8-10 bạn, cam kết đầu ra bằng văn bản và mô hình 1 giáo viên + 1 mentor đồng hành riêng từng học viên. Bạn quan tâm tiêu chí nào nhất để mình tư vấn đúng trọng tâm ạ?', N'confident', N'all'),
    (N'KB-026', N'Objection', N'(?i)(cam kết|đảm bảo.*đầu ra|không đạt thì sao)', N'Trung tâm cam kết đầu ra bằng văn bản cho các khoá học ạ. Kèm theo là 1 giáo viên + 1 mentor theo sát từng học viên, cứ 5 buổi có 1 buổi ôn tập và feedback định kỳ 2 chiều. Mình gửi bạn điều khoản cam kết chi tiết để bạn yên tâm nhé?', N'reassuring', N'all'),
    (N'KB-027', N'Objection', N'(?i)(học online.*hiệu quả|online.*được không|sợ online)', N'Lớp online của trung tâm là lớp trực tiếp có giáo viên dạy thật: bạn tương tác và hỏi đáp ngay trong buổi học, có mentor riêng kèm suốt khoá, mỗi buổi đều có video ghi lại để ôn. Bạn muốn dự thính 1 buổi để tự trải nghiệm không ạ?', N'reassuring', N'all'),
    ...
    (N'KB-029', N'Objection', N'(?i)(lo.*quên|học xong quên|không có ai luyện)', N'Trung tâm có hệ thống LMS với flashcard, bài tập và ghi chú ôn tập, cứ 5 buổi lại có 1 buổi ôn, cùng mentor riêng nhắc lịch ôn để chống quên ạ. Bạn muốn mình tư vấn lộ trình duy trì phù hợp với mục tiêu của bạn không ạ?', N'encouraging', N'all'),
    (N'KB-030', N'Objection', N'(?i)(ưu đãi|khuyến mãi|giảm giá|coupon|mã giảm)', N'Hiện khoá đơn được ưu đãi 20% so với giá niêm yết, đóng full một lần được xét tới 25%, còn combo nhiều cấp giảm tới 30% — càng dài càng rẻ theo buổi ạ. Bạn muốn mình báo mức ưu đãi cụ thể cho khoá bạn quan tâm không ạ?', N'urgency', N'all'),
    ...
    (N'KB-032', N'Action', N'(?i)(đặt lịch|book.*(thử|test)|hẹn.*học thử)', N'Mình đặt lịch học thử miễn phí cho bạn nhé. Bạn chọn giúp mình khung giờ: sáng 8h30-10h, tối 18h30-20h hay 20h-21h30, theo nhóm ngày 2-4-6 hoặc 3-5-7? Mình cần thêm số điện thoại để gửi link lớp và nhắc lịch ạ.', N'action', N'all'),
    ...
    (N'KB-035', N'Action', N'(?i)(khai giảng|lớp mới|khi nào học|lịch khai giảng)', N'Trung tâm khai giảng lớp mới liên tục ở ba khung giờ 8h30-10h, 18h30-20h và 20h-21h30, theo nhóm ngày 2-4-6 hoặc 3-5-7 ạ. Bạn hợp khung giờ nào để mình giữ chỗ lớp gần nhất cho bạn nhé?', N'urgency', N'all'),
    ...
    (N'KB-039', N'Action', N'(?i)(địa điểm học|đến trung tâm|tới cơ sở|đường đi)', N'Trung tâm dạy 100% online nên bạn không cần đến cơ sở ạ — bạn học lớp trực tiếp qua Zoom với giáo viên, ở tỉnh thành nào cũng học được. Mình gửi bạn link tham gia buổi học thử qua tin nhắn nhé, bạn hợp khung giờ nào ạ?', N'helpful', N'all'),
